...
Reads in EXIF data of Post Thumbnail, then adds Post tags and a custom meta value containing the serialized GPS location data of the Post's Featured Image.
